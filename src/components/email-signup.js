					...
					<div className="mt-4 flex flex-col justify-center items-center">
						...
						<form className="mt-4 sm:flex w-full max-w-lg">
							...
							<input
								...
								autoComplete="email"
								required
								className="appearance-none w-full border-2 border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-yellow-500 dark:focus:border-yellow-500 focus:placeholder-gray-400"
